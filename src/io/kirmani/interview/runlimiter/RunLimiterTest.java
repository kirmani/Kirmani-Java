...
public class RunLimiterTest {
    ...
    private RunLimiter mRunLimiter;

    @Before
    public void initialize() {
        mRunLimiter = new RunLimiter();
    }
    ...
    public void testMeetsSpecInFirstSecond() {
        ...
        assertEquals("CanExec() should have been true 100 times.", 100, timesTrue[0]);
    }
    ...
    public void testMeetsSpecAfterFirstSecond() {
        ...
        assertEquals("CanExec() should have been true 100 times at this point.",
                100, timesTrue[0]);
        executeOverInterval(190, NANO_IN_SEC * 11 / 10, timesExecuted, timesTrue, startTime);
        assertEquals("CanExec() should have been executed 190 times at this point.",
                190, timesExecuted[0]);
        assertEquals("CanExec() should have been true 100 times at this point.",
                100, timesTrue[0]);
        executeOverInterval(200, NANO_IN_SEC * 19 / 10, timesExecuted, timesTrue, startTime);
        assertEquals("CanExec() should have been executed 200 times at this point.",
                200, timesExecuted[0]);
        assertEquals("CanExec() should have been true 110 times at this point.",
                110, timesTrue[0]);
    }
